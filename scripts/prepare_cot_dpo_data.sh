...
train_datasets=(
  "asvspoof2019 data_cot/asvspoof2019/train.json"
  "codecfake_ntu data_cot/codecfake_ntu/train.json"
  "ljspeech data_cot/ljspeech/train.json"
  "partial_edit data_cot/partial_edit/train.json"
  "partial_spoof data_cot/partial_spoof/train.json"
  "recent_tts data_cot/recent_tts/train.json"
#   "sine data_cot/sine/train.json"
  "sine data_cot/sine/train_no_vocoder.json"
  "vctk data_cot/vctk/train.json"
  "wavefake data_cot/wavefake/train.json"
)

val_datasets=(
  "asvspoof2019 data_cot/asvspoof2019/dev.json"
  "codecfake_ntu data_cot/codecfake_ntu/val.json"
  "ljspeech data_cot/ljspeech/val.json"
  "partial_edit data_cot/partial_edit/val.json"
  "partial_spoof data_cot/partial_spoof/dev.json"
  "recent_tts data_cot/recent_tts/val.json"
#   "sine data_cot/sine/val.json"
  "sine data_cot/sine/val_no_vocoder.json"
  "vctk data_cot/vctk/val.json"
  "wavefake data_cot/wavefake/val.json"
)
