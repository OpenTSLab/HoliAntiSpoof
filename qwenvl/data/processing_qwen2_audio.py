    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen2AudioProcessorKwargs],
        ...
        if audio is not None:
            ...
            # print("audio kwargs: ", output_kwargs["audio_kwargs"])
                ...
                while self.audio_token in sample:
                    ...
                    has_bos = (
                        sample[audio_token_start_idx -
                               len(self.audio_bos_token):audio_token_start_idx] == self.audio_bos_token
                    )
                    has_eos = (
                        sample[audio_token_end_idx:audio_token_end_idx +
                               len(self.audio_eos_token)] == self.audio_eos_token
                    )
        ...
        # print("text kwargs: ", output_kwargs["text_kwargs"])
